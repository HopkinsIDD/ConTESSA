          ...
          fluidRow(
            column(
              ...
              box(
                ...
                numericInput(
                  "n_detect_quar",
                  "S4. Over the past 4 weeks, what is the average weekly number of newly isolated cases (from S3) that were already in quarantine?",
                  0,
                  0,
                  1e10
                ),
              ...
              conditionalPanel(
                ...
                fluidRow(
                  box(
                    ...
                    numericInput(
                      "n_detect_quar_a",
                      "S4. Over the past 4 weeks, what is the average weekly number of newly isolated cases that were already in quarantine? (Scenario A)",
                      0,
                      0,
                      1e10
                    ),
                  ...
                  box(
                    ...
                    numericInput(
                      "n_detect_quar_b",
                      "S4. Over the past 4 weeks, what is the average weekly number of newly isolated cases that were already in quarantine? (Scenario B)",
                      0,
                      0,
                      1e10
                    ),
