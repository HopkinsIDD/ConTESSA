...
| `r glue("{if (p$quarantine_time < Inf) 'Length of quarantine (days)'}")` | `r glue("{if (p$quarantine_time < Inf) p$quarantine_time}")` | `r if(p$quarantine_time < Inf) ifelse(p$quarantine_time == pB$quarantine_time, glue("-"), glue("{pB$quarantine_time}"))`
...
Full details of this model can be found [here](https://doi.org/10.1101/2020.09.02.20186916).  An interactive application implementing this model to explore the effectiveness of contact tracing programs can be found [here](https://docs.google.com/document/d/e/2PACX-1vQaNPfDKAa9RcQi-ckAq8BZ_f0A0zistlJ9pH1FQSu5rMdbU2qD7JXaeOyIa1IkbRUFqlADRu00iL1r/pub).
