...
| `r glue("{if (p$quarantine_time < Inf) 'Quarantine Days'}")` | `r glue("{if (p$quarantine_time < Inf) p$quarantine_time}")` | `r ifelse(p$quarantine_time == pB$quarantine_time, glue(""), glue("{pB$quarantine_time}"))`
